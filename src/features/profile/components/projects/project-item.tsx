            ...
            <CollapsibleTrigger className="flex w-full items-center gap-4 p-4 pr-2 text-left select-none">
              ...
              <SimpleTooltip content="Open Project Link">
                ...
                >
                  ...
                  <span className="sr-only">Open Project Repo</span>
                </a>
              </SimpleTooltip>
...
<CollapsibleContent className="group overflow-hidden duration-300 data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
  <div className="border-t border-dashed border-edge flex flex-col md:flex-row">
    
    {/* Video section */}
    <div className="video border-b md:border-b-0 md:border-r border-dashed border-edge p-2 flex items-center justify-center">
